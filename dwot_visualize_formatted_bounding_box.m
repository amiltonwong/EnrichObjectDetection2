...
[result_im, clipped_bounding_box ] = dwot_draw_overlay_predictions(im, renderings,...
...
if nargout == 0
    ...
    dwot_visualize_bounding_boxes(clipped_bounding_box, prediction_score, text_template, text_tuples, color_range, color_map)
end
