function [detectors, detector_name]= dwot_make_detectors_slow_gpu(Mu, Gamma, mesh_path, azs, els, yaws, fovs, n_cell_limit, lambda, visualize)
      ...
      for elIdx = 1:numel(els)
        for yawIdx = 1:numel(yaws)
          for fovIdx = 1:numel(fovs)
            ...
            [WHOTemplate] = WHOTemplateCG_GPU( im, scrambleKernel, Mu, GammaGPU, gammaDim(1), n_cell_limit, lambda, padding, hog_cell_threshold, CG_THREASHOLD, CG_MAX_ITER, N_THREAD);
            toc;
