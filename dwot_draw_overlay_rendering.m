function [result_im, clip_bnd] = dwot_draw_overlay_rendering(im, box_position, rendering, depth_mask, rendering_image_weight)
...
clip_bnd = dwot_clip_bounding_box(box_position, image_size);
