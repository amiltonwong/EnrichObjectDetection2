...
% Linux example
if isunix && ~ismac
  !nvcc -v -O3 -DNDEBUG  -gencode=arch=compute_30,code=sm_30 -c cudaDecorrelateFeature.cu -Xcompiler -fPIC -I/afs/cs/package/matlab-r2013b/matlab/r2013b/extern/include -I/afs/cs/package/matlab-r2013b/matlab/r2013b/toolbox/distcomp/gpu/extern/include
