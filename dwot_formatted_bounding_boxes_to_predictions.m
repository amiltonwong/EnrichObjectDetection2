function [prediction_boxes, prediction_scores, template_indexes, overlaps, viewpoints] = dwot_formatted_bounding_boxes_to_predictions(formatted_bounding_boxes) 
