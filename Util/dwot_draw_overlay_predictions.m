function [result_im, clipped_bounding_box ] = dwot_draw_overlay_predictions(im, renderings, depth_masks, prediction_bounding_boxes, rendering_image_weight, draw_padding)
...
for prediction_idx = 1:n_predictions
    ...
    [result_im, clip_bnd] = dwot_draw_overlay_rendering(result_im, box_position, rendering, depth_mask, rendering_image_weight);
