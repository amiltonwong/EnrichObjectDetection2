...
try
  tic
  renderer.setViewpoint(90 + 90,0,0,0,25);
...
%   A_kernel = gather(AGPU);
  ...
  [A_mex, WHO_ACTIVE_CELLS] = cudaDecorrelateFeature(param.hog_gamma_gpu, single(nonEmptyHOG(:)), wHeight, wWidth, HOGDim, nonEmptyRows, nonEmptyCols, lambda);
