function [hog_region_pyramid, im_region] = dwot_extract_hog_region_from_image( bbs_nms, im, param, visualize)
...
for region_idx = 1:n_regions
    [hog_region_pyramid{region_idx}, im_region{region_idx}] = extract_hog(bbs_nms(region_idx, :), im, param);
    if nargout > 1 
...
function [hog_region_pyramid] = extract_hog(bbox, im, param)
  ...
  hog_region_pyramid.image_bbox = bbox(1:4);
